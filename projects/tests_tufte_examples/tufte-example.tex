...
\begin{figure*}[p]
\fbox{\includegraphics[width=0.45\linewidth]{591px-12_tribus_de_Israel_fr.png}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{1695_Eretz_Israel_map_in_Amsterdam_Haggada_by_Abraham_Bar-Jacob.jpg}}
\\\vspace{\baselineskip}
\fbox{\includegraphics[width=0.45\linewidth]{jerusale.jpg}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{palestin.jpg}}
\end{figure*}
...
\fbox{\includegraphics[width=0.45\linewidth]{empires.jpg}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{atlas3.jpg}}
\\\vspace{\baselineskip}
\fbox{\includegraphics[width=0.45\linewidth]{atlas2.jpg}}
\hfill
\fbox{\includegraphics[width=0.45\linewidth]{atlas1.jpg}}
\end{figure*}
...
\begin{marginfigure}%
  \includegraphics[width=\linewidth]{solomon-temple-plan.jpg}
...
\textbackslash begin\{marginfigure\}\\
  \qquad\textbackslash includegraphics\{solomon_dimensions.gif\}\\
...
\begin{figure*}[h]
  \includegraphics[width=\linewidth]{templeinside.jpg}%
...
\begin{figure}
  \includegraphics{J Tablet 2013-1.JPG}
